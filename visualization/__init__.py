...
from visualization.plot_metric_for_mixtures import (
    plot_metric_against_threshold,
    plot_metric_for_mixtures,
)
...
task_colors_to_algos_ablation = {
    "Random": {
        a: colorscheme_blues[i]
        for i, a in enumerate(
            [
                GPonRealSpace().get_name(),
                "GPsqexp",
