...
run_single_regression_task(dataset=dataset, representation=representation, method=GPonRealSpace(kernel=Polynomial(degree=7.) + SquaredExponential() + SquaredExponential() * Polynomial(degree=7.)), train_test_splitter=block_position_splitter)
