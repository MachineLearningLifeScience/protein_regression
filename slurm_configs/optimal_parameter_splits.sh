...
OPTIMAL_RF_PARAM_FILENAME_REFERENCE="RF_optimal_estimators_1FQG_esm_RandomSplitter_None_s"
OPTIMAL_RF_PARAM_FILENAME="RF_optimal_estimators_1FQG_esm_FractionalRandomSplitter"
FRACTIONS=("0.36" "0.39" "0.42" "0.45" "0.48" "0.51" "0.54" "0.57" "0.6" "0.65" "0.7" "0.75" "0.8" "0.85" "0.85" "0.9" "0.95" "1.0")
