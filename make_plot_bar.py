...
train_test_splitter = BlockPostionSplitter # RandomSplitter # BioSplitter
...
if __name__ == "__main__":
    datasets = ["UBQT", "1FQG", "CALM"] # ["TOXI"] # "MTH3", "TIMB", "UBQT", "1FQG", "CALM", "BRCA"
    ...
    metrics = [MSE]
    representations = [ONE_HOT, VAE, VAE_AUX, TRANSFORMER, ESM] # # SPECIAL CASE [UBQT, BLAT]: VAE+"_clusterval" 
    dim = None
