...
if __name__ == "__main__":
    datasets = ["UBQT"] # "TIMB", "CALM", "1FQG", "UBQT", "BRCA"
    ...
    representations = [TRANSFORMER, ESM, ONE_HOT, EVE] # TODO: curve fitting for VAE broken? DEBUG!
    dimensions = [2, 10, 100, 1000, None]
    dim_reduction = LINEAR # LINEAR, NON_LINEAR
    cv_types = [PositionSplitter(datasets[0]), RandomSplitter(datasets[0])]
